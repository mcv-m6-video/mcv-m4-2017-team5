...
function [detection, isObjectDetected] = detectObject(frame)
  ...
  utilities.foregroundMask = imfill(utilities.foregroundMask,4,'holes');
  utilities.foregroundMask = bwareaopen(utilities.foregroundMask,80,4);
  utilities.foregroundMask = imopen(utilities.foregroundMask, strel('line',30,45));
  utilities.foregroundMask = imclose(utilities.foregroundMask,strel('diamond',20));
...
function utilities = createUtilities(param)
  ...
  utilities.videoReader = vision.VideoFileReader('traffic_stabilized.avi');
  ...
  utilities.blobAnalyzer = vision.BlobAnalysis('AreaOutputPort', false, ...
    'MinimumBlobArea',400, 'CentroidOutputPort', true);
